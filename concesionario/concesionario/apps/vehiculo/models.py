...
class Vehiculo(models.Model):
	...
	marca = models.ChartField(null=True,blank=True,max_length=50)
	...
	motor = models.ChartField(null=True,blank=True,max_length=50)
	caracteristicas = models.TextField(null=True,blank=True)
	capacidad = models.IntegerField(null=True,blank=True)
	color = models.ChartField(null=True,blank=True)
	...
	tipos = (
		...
		(MICROBUS,MICROBUS),
		(BUSETA,BUSETA),
		(BUS_METROPOLITANO,BUS_METROPOLITANO),
		(CAMION_MEDIANO_F350,CAMION_MEDIANO_F350),
		(CAMION_GRADE_F600,CAMION_GRADE_F600),
		(CAMION_C3,CAMION_C3),
		(TRACTO_CAMION,TRACTO_CAMION),
		(CAMION_C4,CAMION_C4),
		)

	tipo = models.ChartField(null=True,blank=True,max_length=100,choices=tipos,default=AUTOMOVIL)
